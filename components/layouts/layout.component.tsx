...
export const Layout = (props: PropsWithChildren<unknown>) => {
  ...
  return (
    <div className=" bg-[#f8f8f8]  h-screen grow flex ">
      ...
      <div
        className={classNames(
          "flex flex-col gap-10 w-full max-w-57.5 md:max-w-63 bg-white border-r border-[#DADADA] fixed left-0 h-full pt-8 px-4 md:pl-8 transition-transform duration-200 ease-out z-50",
          {
      ...
      {/* Topbar */}
      <div className="fixed top-0 left-0 right-0 md:left-63 z-30 bg-white border-b border-[#DADADA] ">
          ...
          <div className="flex items-center md:w-full justify-between gap-4">
            ...
            >
              ...
              <div
                ref={profileMenuRef}
                className={classNames(
                  "absolute top-full left-0 md:left-auto md:-right-20 mt-3 w-55 bg-white z-20 rounded-xl border border-[#DADADA] shadow-[2px_4px_10px_#00000014] p-2 origin-top-right ",
                  isProfileMenuOpen
                    ? "pointer-events-auto"
                    : "pointer-events-none",
                )}
          ...
          {!user?.nationalIdentificationNumberVerified && (
            <div className="border-[#960018] border-l-4 bg-[#FFE2E2] flex gap-4 p-4 mb-10 ">
              ...
              <div className="flex flex-col gap-0.75">
                ...
                <p className="text-xs text-[#5A403F] max-w-200">
