  ...
  return (
    <HomeLayout>
      <div className="flex-1 flex-col ">
        ...
        >
          <motion.div
            className="col-span-1 md:col-span-3 flex flex-col px-4 sm:px-6 md:pl-19.5 pt-8 sm:pt-12 md:pt-15.5 gap-6 sm:gap-8 md:gap-7.25 pb-8 sm:pb-12 md:pb-26.75 pr-4 sm:pr-6 md:pr-22.5 bg-[#F4F2FF]"
            variants={fadeInLeft}
          >
            <motion.div
              className="flex flex-col gap-4 sm:gap-6"
          ...
          <motion.div
            className="relative col-span-1 md:col-span-2 bg-white md:-translate-x-10 md:translate-y-8.25 flex flex-col gap-8 sm:gap-12 md:gap-16.5 px-4 sm:px-6 md:px-0"
            variants={fadeInRight}
          >
            <motion.div
              className="flex flex-col gap-8 sm:gap-12 md:gap-20.5 mt-8 sm:mt-12 md:mt-15 max-w-120.5 px-4 sm:px-6 md:px-14.5"
              variants={staggerContainer}
              initial="initial"
              animate="animate"
            >
            ...
            <motion.div
              className="flex gap-2.25 items-center ml-4 sm:ml-6 md:ml-6.25 mb-6 sm:mb-8 md:mb-5.25"
              whileHover={{ x: 5 }}
            >
        ...
        >
          ...
          <motion.div
            className="col-span-1 md:col-span-3 relative z-0 min-h-75 sm:min-h-100 md:min-h-125"
            variants={fadeInRight}
          >
            <Image
        ...
        >
          ...
          <div className="flex flex-col gap-6 sm:gap-8 md:gap-8.5">
            <div className="flex flex-col lg:flex-row gap-4">
              <motion.div
                className="relative w-full lg:w-161.75 min-h-75 sm:min-h-100"
                variants={scaleIn}
