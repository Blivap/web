...
import { ArrowLeft, BookOpen, GraduationCap, FileText, CheckCircle } from "lucide-react";
          ...
          <div className="flex flex-col gap-4 sm:gap-6 md:gap-8">
            ...
            >
              {[
                ...
                >
                  <div className={`${topic.color} p-3 sm:p-4 rounded-full w-fit mb-3 sm:mb-4`}>
                    <topic.icon className="text-primary" size={24} />
                  </div>
                  <h3 className="font-semibold text-lg sm:text-xl mb-2 sm:mb-3">{topic.title}</h3>
                  <p className="text-sm sm:text-base text-[#333333] mb-4">{topic.desc}</p>
                  <Link
                    href={topic.link}
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-6">
                ...
                <div>
                  <h4 className="font-semibold text-base mb-2">For Recipients</h4>
                  <ul className="flex flex-col gap-2 text-sm text-[#333333]">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="text-primary mt-1" size={16} />
            ...
            >
              ...
              <p className="text-sm sm:text-base text-[#333333] leading-relaxed mb-6">
                ...
                discover how you can contribute to saving lives. Education is the 
                first step toward making a meaningful difference.
              </p>
