      ...
      <div className="flex-1 flex flex-col px-4 sm:px-6 md:px-8 lg:px-20 py-6 sm:py-8 md:py-10 max-w-xl mx-auto">
        <div className="flex flex-col gap-3">
          ...
          <p className="text-xs text-[#6B7280] leading-relaxed">
            See how Blivap can help your organization. We&apos;ll walk you through the platform.
          </p>
        </div>
        ...
        {submitted ? (
          ...
          >
            <div>
              <label htmlFor="name" className="block text-xs font-medium text-[#374151] mb-1">
                Name
              </label>
              <input
                id="name"
            ...
            <div>
              <label htmlFor="email" className="block text-xs font-medium text-[#374151] mb-1">
                Email
              </label>
              <input
                id="email"
            ...
            <div>
              <label htmlFor="organization" className="block text-xs font-medium text-[#374151] mb-1">
            ...
            <div>
              <label htmlFor="message" className="block text-xs font-medium text-[#374151] mb-1">
