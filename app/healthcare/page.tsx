...
import { ArrowLeft, Stethoscope, Users, FileText, Calendar, CheckCircle } from "lucide-react";
          ...
          <div className="flex flex-col gap-4 sm:gap-6 md:gap-8">
            ...
            >
              ...
              <p className="text-sm sm:text-base text-[#333333] leading-relaxed max-w-3xl">
                ...
                donations. Join our network of medical facilities and help save lives.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-6">
                <div>
                  <h4 className="font-semibold text-base mb-2">For Your Practice</h4>
                ...
                <div>
                  <h4 className="font-semibold text-base mb-2">Support & Training</h4>
                  <ul className="flex flex-col gap-2 text-sm text-[#333333]">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="text-primary mt-1" size={16} />
            ...
            >
              ...
              <p className="text-sm sm:text-base text-[#333333] leading-relaxed mb-6">
                ...
                Register your facility today and become part of a life-saving network.
              </p>
              <motion.div
