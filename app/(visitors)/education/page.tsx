      ...
      <div className="flex-1 flex flex-col py-6 sm:py-8 text-[#111827] dark:text-slate-300">
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-6">
              ...
              {[
                {
                  ...
                  link: "/about-blood",
                  color: "bg-[#F9E8EE] dark:bg-primary/15",
                },
                {
                  icon: GraduationCap,
                  ...
                  link: "/about-sperm",
                  color: "bg-[#E4E5FF] dark:bg-sky-500/15",
                },
                {
                  icon: FileText,
                  title: "Resources",
                  ...
                  link: "/faq",
                  color: "bg-[#F4F2FF] dark:bg-indigo-500/15",
                },
              ].map((topic, i) => (
                <div
                  key={i}
                ...
                >
                  ...
                  <p className="text-xs text-[#6B7280] dark:text-slate-400 mb-3 leading-relaxed">
                    {topic.desc}
                  </p>
                  <Link
                    href={topic.link}
            ...
            <div className="bg-white text-[#111827] dark:bg-[#111827] dark:text-white p-4 rounded-lg mt-4 border border-[#E5E7EB] dark:border-white/10">
              <h2 className="font-semibold text-base text-black dark:text-white mb-3">
                Educational topics
              </h2>
            ...
            <div className="bg-[#F9FAFB] text-[#111827] dark:bg-[#0F172A] dark:text-white p-4 rounded-lg mt-4 border border-[#E5E7EB] dark:border-white/10">
