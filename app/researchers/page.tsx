...
import { ArrowLeft, FlaskConical, Database, Users, TrendingUp, CheckCircle } from "lucide-react";
          ...
          <div className="flex flex-col gap-4 sm:gap-6 md:gap-8">
            ...
            >
              ...
              <p className="text-sm sm:text-base text-[#333333] leading-relaxed max-w-3xl">
                ...
                healthcare professionals, and institutions, enabling groundbreaking 
                research in blood products, diagnostics, and healthcare delivery.
              </p>
            </motion.div>
            ...
            >
              {[
                ...
                >
                  <div className={`${feature.color} p-3 sm:p-4 rounded-full w-fit mb-3 sm:mb-4`}>
                    <feature.icon className="text-primary" size={24} />
                  </div>
                  <h3 className="font-semibold text-lg sm:text-xl mb-2 sm:mb-3">{feature.title}</h3>
                  <p className="text-sm sm:text-base text-[#333333]">{feature.desc}</p>
                </motion.div>
              ))}
            </motion.div>
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-6">
                <div>
                  <h4 className="font-semibold text-base mb-2">For Your Research</h4>
                ...
                <div>
                  <h4 className="font-semibold text-base mb-2">Collaboration Network</h4>
                  <ul className="flex flex-col gap-2 text-sm text-[#333333]">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="text-primary mt-1" size={16} />
            ...
            >
              ...
              <p className="text-sm sm:text-base text-[#333333] leading-relaxed mb-6">
                ...
                through groundbreaking research. Our team will guide you through 
                the registration and data access process.
              </p>
              <motion.div
