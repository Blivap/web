          ...
          <div className="flex flex-col gap-4 sm:gap-6 md:gap-8">
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-6">
                <div>
                  <h4 className="font-semibold text-base mb-2">Platform Benefits</h4>
                ...
                <div>
                  <h4 className="font-semibold text-base mb-2">Support Services</h4>
                  <ul className="flex flex-col gap-2 text-sm text-[#333333]">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="text-primary mt-1" size={16} />
            ...
            >
              ...
              <p className="text-sm sm:text-base text-[#333333] leading-relaxed mb-6">
                ...
                outcomes together. Contact us today to learn more about partnership 
                opportunities and how we can support your practice.
              </p>
              <motion.div
