  ...
  return (
    ...
    >
      ...
      <section className={cardClass}>
        ...
        <Sk className="mt-1 h-3 w-[88%]" />
        <Sk className="mx-auto mt-4 h-8 w-40 max-w-full" />
      ...
      <section className={cardClass}>
        ...
        <div className="mt-6 border-t border-border pt-4 dark:border-white/10">
          ...
          <Sk className="mt-1 h-3 w-full max-w-lg" />
          <Sk className="mt-2 h-[72px] w-full rounded-lg" />
          <Sk className="mt-2 h-9 w-36 rounded-lg" />
        </div>
      </section>
